      ...
      for (var y = 0; y < h; ++y) {
        ...
        for (var x = 0; x < w; ++x) {
          ...
          dst.setPixelRgba(
              x1 + x,
              dstY,
              copyResizeLinear(icc.r.toDouble(), inc.r.toDouble(),
                  icn.r.toDouble(), inn.r.toDouble(), kx, ky),
              copyResizeLinear(icc.g.toDouble(), inc.g.toDouble(),
                  icn.g.toDouble(), inn.g.toDouble(), kx, ky),
              copyResizeLinear(icc.b.toDouble(), inc.b.toDouble(),
                  icn.b.toDouble(), inn.b.toDouble(), kx, ky),
              copyResizeLinear(icc.a.toDouble(), inc.a.toDouble(),
                  icn.a.toDouble(), inn.a.toDouble(), kx, ky));
        }
      }
    } else {
      for (var y = 0; y < h; ++y) {
