...
final exifImageTags = <int, ExifTag>{
  ...
  0x0100: ExifTag('ImageWidth', IfdValueType.long),
  0x0101: ExifTag('ImageLength', IfdValueType.long),
  0x0102: ExifTag('BitsPerSample', IfdValueType.short),
  0x0103: ExifTag('Compression', IfdValueType.short),
  0x0106: ExifTag('PhotometricInterpretation', IfdValueType.short),
  0x0107: ExifTag('Thresholding', IfdValueType.short),
  0x0108: ExifTag('CellWidth', IfdValueType.short),
  0x0109: ExifTag('CellLength', IfdValueType.short),
  0x010A: ExifTag('FillOrder', IfdValueType.short),
  ...
  0x0112: ExifTag('Orientation', IfdValueType.short),
  0x0115: ExifTag('SamplesPerPixel', IfdValueType.short),
  0x0116: ExifTag('RowsPerStrip', IfdValueType.long),
  0x0117: ExifTag('StripByteCounts', IfdValueType.long),
  0x0118: ExifTag('MinSampleValue', IfdValueType.short),
  0x0119: ExifTag('MaxSampleValue', IfdValueType.short),
  0x011A: ExifTag('XResolution', IfdValueType.rational),
  0x011B: ExifTag('YResolution', IfdValueType.rational),
  0x011C: ExifTag('PlanarConfiguration', IfdValueType.short),
  0x011D: ExifTag('PageName', IfdValueType.ascii),
  0x011E: ExifTag('XPosition', IfdValueType.rational),
  0x011F: ExifTag('YPosition', IfdValueType.rational),
  0x0122: ExifTag('GrayResponseUnit', IfdValueType.short),
  0x0123: ExifTag('GrayResponseCurve'),
  0x0124: ExifTag('T4Options'),
  0x0125: ExifTag('T6Options'),
  0x0128: ExifTag('ResolutionUnit', IfdValueType.short),
  ...
  0x013D: ExifTag('Predictor', IfdValueType.short),
  ...
  0x0142: ExifTag('TileWidth', IfdValueType.long),
  0x0143: ExifTag('TileLength', IfdValueType.long),
  ...
  0x0212: ExifTag('YCbCrSubSampling', IfdValueType.short),
  0x0213: ExifTag('YCbCrPositioning', IfdValueType.short),
  0x0214: ExifTag('ReferenceBlackWhite', IfdValueType.rational, 6),
  0x02BC: ExifTag('ApplicationNotes', IfdValueType.short), // XPM Info
  0x4746: ExifTag('Rating', IfdValueType.short),
  ...
  0x829A: ExifTag('ExposureTime', IfdValueType.rational),
  0x829D: ExifTag('FNumber', IfdValueType.rational),
  0x83BB: ExifTag('IPTC-NAA', IfdValueType.long),
  0x8769: ExifTag('ExifOffset'), // Exif Tags
  0x8773: ExifTag('InterColorProfile'),
  0x8822: ExifTag('ExposureProgram', IfdValueType.short),
  0x8824: ExifTag('SpectralSensitivity', IfdValueType.ascii),
  0x8825: ExifTag('GPSOffset'), // GPS tags
  0x8827: ExifTag('ISOSpeed', IfdValueType.long),
  0x8828: ExifTag('OECF'),
  0x8830: ExifTag('SensitivityType', IfdValueType.short),
  0x8832: ExifTag('RecommendedExposureIndex', IfdValueType.long),
  0x8833: ExifTag('ISOSpeed', IfdValueType.long),
  ...
  0xA001: ExifTag('ColorSpace', IfdValueType.short),
  0xA002: ExifTag('ExifImageWidth', IfdValueType.short),
  0xA003: ExifTag('ExifImageLength', IfdValueType.short),
  ...
  0xA500: ExifTag('Gamma', IfdValueType.rational),
...
final exifInteropTags = <int, ExifTag>{
  ...
  0x1001: ExifTag('RelatedImageWidth', IfdValueType.short),
