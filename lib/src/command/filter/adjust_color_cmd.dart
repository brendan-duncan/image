...
class AdjustColorCmd extends Command {
  ...
  AdjustColorCmd(Command? input, { this.blacks, this.whites, this.mids,
      num? contrast, this.saturation, this.brightness,
      num? gamma, this.exposure, this.hue,
  ...
  Future<void> executeCommand() async {
    ...
    outputImage = img != null ? g.adjustColor(img, blacks: blacks,
        ...
        hue: hue, amount: amount, mask: maskImg, maskChannel: maskChannel)
        : null;
  }
}
