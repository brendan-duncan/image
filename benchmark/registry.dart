...
class PngSample {
  ...
  String get resolution => [width, height].join('x');
}
...
Map<String, List<BenchmarkCase>> buildCases() {
  ...
  String resTo(Image img, int w, int h) =>
      '${img.width}x${img.height} -> ${[w, h].join('x')}';
  ...
  for (final s in samples) {
    ...
    add(
      ...
      BenchmarkCase(
        'encodeNamedImage',
        () => encodeNamedImage('out.png', s.image),
        resolution: s.resolution,
      ),
    );
    ...
    add(
      ...
      BenchmarkCase(
        'gaussianBlur',
        () => gaussianBlur(s.image.clone(), radius: 5),
        resolution: s.resolution,
      ),
    );
    add(
    ...
    add(
      ...
      BenchmarkCase(
        'contrast',
        () => contrast(s.image.clone(), contrast: 120),
        resolution: s.resolution,
      ),
    );
    add(
    ...
    add(
      ...
      BenchmarkCase(
        'scaleRgba',
        () => scaleRgba(s.image.clone(), scale: ColorRgba8(200, 180, 160, 255)),
        resolution: s.resolution,
      ),
    );
    add(
    ...
    add(
      ...
      BenchmarkCase(
        'smooth',
        () => smooth(s.image.clone(), weight: 1.2),
        resolution: s.resolution,
      ),
    );
    add(
    ...
    add(
      ...
      BenchmarkCase(
        'dropShadow',
        () => dropShadow(s.image.clone(), 8, 8, 4),
        resolution: s.resolution,
      ),
    );
    add(
    ...
    add(
      ...
      BenchmarkCase('compositeImage', () {
        ...
        final src = makeSolidImage(
          s.width ~/ 2,
          s.height ~/ 2,
          color: ColorRgb8(200, 50, 50),
        );
        compositeImage(dst, src, dstX: s.width ~/ 4, dstY: s.height ~/ 4);
      }, resolution: s.resolution),
    );
  }
  ...
  add(
    ...
    BenchmarkCase(
      'encodeCur',
      () => encodeCur(iconImage, singleFrame: true),
      resolution: '32x32',
      note: 'fixed size',
    ),
  );
  add(
    ...
    BenchmarkCase(
      'encodeIco',
      () => encodeIco(iconImage, singleFrame: true),
      resolution: '32x32',
      note: 'fixed size',
    ),
  );
  add(
    ...
    BenchmarkCase(
      'encodePvr',
      () => encodePvr(pvrImage, singleFrame: true),
      resolution: '128x128',
      note: 'fixed size',
    ),
  );
