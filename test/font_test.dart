...
void defineFontTests() {
  ...
  group('bitmapFont', () {
    test('zip/xml', () {
      ...
      new Io.File('test/out/font/font_zip_xml.jpg')
    ...
    test('zip/text', () {
      ...
      new Io.File('test/out/font/font_zip_text.jpg')
            ..createSync(recursive: true)
            ..writeAsBytesSync(writeJpg(img));
    });
    ...
    test('arial_14', () {
      ...
      new Io.File('test/out/font/font_arial_14.jpg')
            ..createSync(recursive: true)
            ..writeAsBytesSync(writeJpg(img));
    });
    ...
    test('arial_24', () {
      ...
      new Io.File('test/out/font/font_arial_24.jpg')
            ..createSync(recursive: true)
            ..writeAsBytesSync(writeJpg(img));
    });
    ...
    test('arial_48', () {
      ...
      new Io.File('test/out/font/font_arial_48.jpg')
            ..createSync(recursive: true)
            ..writeAsBytesSync(writeJpg(img));
    });
  });
