...
void definePvrtcTests() {
  group('PVRTC', () {
    test('encode_rgb_4bpp', () {
      ...
      new Io.File('test/out/pvrtc/globe_before.png')
    ...
    test('encode_rgba_4bpp', () {
      ...
      new Io.File('test/out/pvrtc/alpha_before.png')
          ..createSync(recursive: true)
          ..writeAsBytesSync(encodePng(image));
      ...
      new Io.File('test/out/pvrtc/alpha_after.png')
          ..createSync(recursive: true)
          ..writeAsBytesSync(encodePng(decoded));

      List<int> pvr = new PvrtcEncoder().encodePvr(image);
      new Io.File('test/out/pvrtc/alpha.pvr')
          ..createSync(recursive: true)
          ..writeAsBytesSync(pvr);
    });
  });
  ...
  group('PVR Decode', (){
    ...
    for (var f in files) {
      ...
      test(name, () {
        ...
        assert(img != null);
        new Io.File('test/out/pvrtc/pvr_$name.png')
            ..createSync(recursive: true)
