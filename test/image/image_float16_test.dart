...
void imageFloat16Test() {
  test('float16', () {
    final i1 = Image(width: 2, height: 2, format: Format.float16,
        numChannels: 1);
    ...
    final i2 = Image(width: 2, height: 2, format: Format.float16,
        numChannels: 2);
    ...
    final i4 = Image(width: 2, height: 2, format: Format.float16,
        numChannels: 4);
