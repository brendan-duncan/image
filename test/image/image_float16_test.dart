...
void ImageFloat16Test() {
  test('Float16', () {
    final i1 = Image(2, 2, format: Format.float16, numChannels: 1);
    ...
    final i2 = Image(2, 2, format: Format.float16, numChannels: 2);
    ...
    final i3 = Image(2, 2, format: Format.float16);
    ...
    final i4 = Image(2, 2, format: Format.float16, numChannels: 4);
