...
void ImageUint32Test() {
  test('uint32', () {
    final i1 = Image(2, 2, format: Format.uint32, numChannels: 1);
    ...
    i1.setPixelColor(0, 1, 7425);
    i1.setPixelColor(1, 1, 5214245);
    ...
    final i2 = Image(2, 2, format: Format.uint32, numChannels: 2);
    ...
    final i3 = Image(2, 2, format: Format.uint32);
    ...
    final i4 = Image(2, 2, format: Format.uint32, numChannels: 4);
