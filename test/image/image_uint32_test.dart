...
void main() {
  group('Image', () {
    test('uint32', () async {
      final i1 = Image(width: 32, height: 32, format: Format.uint32,
          numChannels: 1);
      ...
      final i2 = Image(width: 32, height: 32, format: Format.uint32,
          numChannels: 2);
      ...
      final i4 = Image(width: 32, height: 32, format: Format.uint32,
          numChannels: 4);
