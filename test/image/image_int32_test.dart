...
void imageInt32Test() {
  test('int32', () {
    final i1 = Image(width: 2, height: 2, format: Format.int32, numChannels: 1);
    ...
    final i2 = Image(width: 2, height: 2, format: Format.int32, numChannels: 2);
    ...
    final i4 = Image(width: 2, height: 2, format: Format.int32, numChannels: 4);
