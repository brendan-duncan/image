...
void main() {
  group('Image', () {
    test('float64', () async {
      final i1 = Image(width: 2, height: 2, format: Format.float64,
          numChannels: 1);
      ...
      final i2 = Image(width: 2, height: 2, format: Format.float64,
          numChannels: 2);
      ...
      final i4 = Image(width: 2, height: 2, format: Format.float64,
          numChannels: 4);
