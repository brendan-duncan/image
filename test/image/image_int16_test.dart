...
void main() {
  group('Image', () {
    test('int16', () async {
      final i1 = Image(width: 2, height: 2, format: Format.int16,
          numChannels: 1);
      ...
      final i2 = Image(width: 2, height: 2, format: Format.int16,
          numChannels: 2);
      ...
      final i4 = Image(width: 2, height: 2, format: Format.int16,
          numChannels: 4);
