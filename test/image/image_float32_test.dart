...
void imageFloat32Test() {
  test('float32', () {
    final i1 = Image(width: 2, height: 2, format: Format.float32,
        numChannels: 1);
    ...
    final i2 = Image(width: 2, height: 2, format: Format.float32,
        numChannels: 2);
    ...
    final i4 = Image(width: 2, height: 2, format: Format.float32,
        numChannels: 4);
