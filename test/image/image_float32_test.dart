...
void ImageFloat32Test() {
  test('Float32', () {
    final i1 = Image(2, 2, format: Format.float32, numChannels: 1);
    ...
    final i2 = Image(2, 2, format: Format.float32, numChannels: 2);
    ...
    final i3 = Image(2, 2, format: Format.float32);
    ...
    final i4 = Image(2, 2, format: Format.float32, numChannels: 4);
