...
void main() {
  group('Image', () {
    group('uint1', () {
      test('nc:1', () async {
        final i1 = Image(width: 32, height: 32, format: Format.uint1,
            numChannels: 1);
      ...
      test('nc:2', () async {
        final i2 = Image(width: 32, height: 32, format: Format.uint1,
            numChannels: 2);
      ...
      test('nc:4', () async {
        final i4 = Image(width: 32, height: 32, format: Format.uint1,
            numChannels: 4);
      ...
      test('nc:3 palette', () async {
        final i5 = Image(width: 32, height: 32, format: Format.uint1,
            withPalette: true);
      ...
      test('nc:4 palette', () async {
        final i6 = Image(width: 32, height: 32, format: Format.uint1,
