...
void main() {
  group('Image', () {
    group('uint16', () {
      test('nc:1', () async {
        final i1 = Image(width: 32, height: 32, format: Format.uint16,
            numChannels: 1);
      ...
      test('nc:2', () async {
        final i2 = Image(width: 32, height: 32, format: Format.uint16,
            numChannels: 2);
      ...
      test('nc:4', () async {
        final i4 = Image(width: 32, height: 32, format: Format.uint16,
            numChannels: 4);
