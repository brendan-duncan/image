...
void DrawImageTest() {
  test('drawImage', () {
    ...
    var fg = decodeTga(File('test/data/tga/globe.tga').readAsBytesSync())!;
    ...
    var bg = decodePng(File('test/data/png/buck_24.png').readAsBytesSync())!;
    drawImage(bg, fg, dstX: 50, dstY: 50);
    File('$tmpPath/out/draw/drawImage_1.png')
      ..createSync(recursive: true)
      ..writeAsBytesSync(encodePng(bg));

    bg = decodePng(File('test/data/png/buck_24.png').readAsBytesSync())!;
